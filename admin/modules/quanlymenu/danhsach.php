    ...
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="col-3 text-end">
                <a href="?action=quanlymenu&query=them" class="btn btn-primary btn-lg"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle align-middle me-2">
